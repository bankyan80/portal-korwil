...
const sekolah='TK AL-IRSYAD AL-ISLAMIYYAH';
const files=[
  {p:'../src/data/pegawai-guru-tkirsyad.csv',role:'guru'},
  {p:'../src/data/pegawai-tendik-tkirsyad.csv',role:'tendik'},
];
const all=[];
