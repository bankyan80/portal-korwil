...
export default function OperatorSpmbPage() {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 py-6 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-gray-900 dark:text-white">SPMB</h1>
            <p className="text-sm text-muted-foreground">Penerimaan Peserta Didik Baru</p>
          </div>
        </div>
        <ManageSpmbSd />
      </div>
