...
export async function GET() {
  ...
  try {
    ...
    const driveRes = await drive.files.list({
      q: `'15o8XOp-mQI4iQnY3mm29lXb2nEWMDShC' in parents and trashed=false`,
      fields: 'files(id, name, mimeType, createdTime)',
      pageSize: 10,
    });

    results.driveApiConnected = true;
    results.folderId = '15o8XOp-mQI4iQnY3mm29lXb2nEWMDShC';
    ...
    const testSheet = await drive.files.create({
      requestBody: {
        ...
        parents: ['15o8XOp-mQI4iQnY3mm29lXb2nEWMDShC'],
      },
