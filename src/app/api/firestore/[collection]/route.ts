...
const PUBLIC_COLLECTIONS = ['announcements', 'menus', 'institution_links', 'organizations', 'contacts', 'faq', 'drive_folders', 'gallery', 'schools', 'students', 'employees', 'alumni', 'employee_mappings', 'lapor_pajak'];
