    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4 py-8">
      <Card className="w-full max-w-md shadow-xl border-0 overflow-hidden">
        ...
        <CardContent className="px-6 pb-6">
          ...
          {/* NPSN Login — Recommended */}
          <div className="p-4 bg-green-50 rounded-lg border border-green-200 space-y-3 mb-4">
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-bold uppercase tracking-wider text-white bg-green-600 px-1.5 py-0.5 rounded">Disarankan</span>
              <span className="text-sm font-semibold text-green-800">Login Operator (NPSN)</span>
            </div>
            <p className="text-xs text-green-700">
              Gunakan NPSN dan password sekolah untuk masuk sebagai operator.
            </p>
          ...
          <div className="mt-4 pt-4 border-t border-gray-100 text-center space-y-3">
            <p className="text-xs text-gray-400">Atau masuk menggunakan</p>
            <button
              type="button"
              onClick={handleGoogleLogin}
              disabled={isGoogleLoading}
              className="inline-flex items-center justify-center w-12 h-12 rounded-full border border-gray-300 hover:bg-gray-50 hover:border-gray-400 transition-colors disabled:opacity-50 cursor-pointer"
