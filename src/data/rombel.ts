...
export const rombelData: RombelEntry[] = [
  ...
  { name: 'TK NEGERI LEMAHABANG', jenjang: 'TK', total: 131, rombels: 8, details: [
   ...
   { name: 'TK AISYIYAH LEMAHABANG', jenjang: 'TK', total: 27, rombels: 2, details: [
     { name: 'A', total: 17, l: 7, p: 10 },
     { name: 'B', total: 10, l: 6, p: 4 },
   ]},
  ...
  { name: 'KB AZ-ZAHRA', jenjang: 'KB', total: 42, rombels: 2, details: [
    { name: 'A', total: 32, l: 14, p: 18 }, { name: 'B', total: 10, l: 7, p: 3 },
  ]},
